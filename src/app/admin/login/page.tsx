  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="grid w-full gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <section className="grid gap-6 rounded-4xl border border-white/60 bg-cyan-950 p-8 text-white shadow-[0_40px_120px_-60px_rgba(8,47,73,0.8)]">
          <div className="inline-flex w-fit rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-cyan-100">
            Admin access
          </div>
          <div className="grid gap-4">
            ...
            <p className="max-w-xl text-base leading-7 text-cyan-100/80">
